...
def transform_nacls_data(network_acls_data):
    data_list = []

    for _, row in network_acls_data.iterrows():
        entries = row['entries']
...
def load_and_transform_network_acls_data(network_acls_data):
    return transform_nacls_data(network_acls_data)
